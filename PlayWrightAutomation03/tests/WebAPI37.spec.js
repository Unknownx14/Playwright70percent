...
const {APIUtils} = require('./Utils/APIUtils'); //This class is imported
...
test.beforeAll( async ()=>   //This is a test function
{
    ...
    const objectAPIUtils =new APIUtils(apiContext, loginPayload); //Object of this APIUtils class
    objectAPIUtils.createOrder(placeOrderPayload);
